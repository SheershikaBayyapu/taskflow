...
export const ThemeProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    else if (theme === 'light') { applyLight(); }
    else {
  ...
  const setAndSave = (t) => { setTheme(t); localStorage.setItem('theme', t); };

  return <ThemeContext.Provider value={{ theme, setTheme: setAndSave }}>{children}</ThemeContext.Provider>;
};
